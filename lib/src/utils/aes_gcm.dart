...
class AESGCMEncryption {
  ...
  Future<Map<String, dynamic>> encryptFile(
    ...
    return {'encryptedData': encryptedData, 'key': key, 'nonce': nonce};
  }
  ...
  Future<Uint8List> decryptFile(
    ...
    final decryptedData = await _aesGcm.decrypt(secretBox, secretKey: key);
  ...
  Future<Map<String, dynamic>> encryptFileForEvent(String filePath) async {
    ...
    return {'encryptedData': encryptedData, 'eventContent': eventContent};
  }
...
void main() async {
  ...
  final originalData = utf8.encode(
    'This is a secret document that needs encryption.',
  );
  ...
  await testFile.writeAsString(
    'This is a test document for Nostr encrypted storage.',
  );
